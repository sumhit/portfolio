      ...
      <div className="grid grid-col-1 sm:grid-cols-12">
        <motion.div
          ...
          <p className="text-[#ADB7BE] text-lg lg:text-xl">
            I thrive on data analytics, captivating presentations, and web
            development, driven by a passion for solving real-world problems and
            delivering innovative solutions. My ability to quickly learn and
            observe enables me to solve complex problems effectively.
          </p>
          <div>
